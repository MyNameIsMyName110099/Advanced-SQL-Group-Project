...
-- Week 2 Deliverables, Item 3 - Seed Data  (file 1 of 4)
--
-- Kelsey Wilcox, Mason Romdenne, Nathan Krouth, Nicholas Fearing
--
-- Positions, Demographic, Suppliers, Dishes, Ingredients. these tables
-- have no foreign keys, so they go in first.
--
